...
public class CaveArea extends BaseArea {
    ...
    public CaveArea(Handler handler, EntityManager entityManager) {
		...
		this.entityManager.AddEntity(handler.newEnemy(Images.sminotaur,handler,700, 2000,"InWorldState","Boss","Cave","Minotaur",300,25,800,100,8,12,20,10,20,10,1,10,"None","Fire",null,null)); // lvl 0 dificulty
