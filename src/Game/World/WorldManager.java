...
// Game.Entities.Dynamics.QuestGiver;
...
public class WorldManager {
	...
	public WorldManager(Handler handler, EntityManager entityManager) {
		...
		circle = handler.getGame().getMouseManager().new Circle(5627,380, this.handler);//5627,380,
		...
		//this.entityManager.AddEntity(new QuestGiver(handler, 1655, 20));
	...
	private void AddWalls() {
		...
		//worldWalls.add(new Walls(handler,  600, 600, 20, 20, "Door S"));	
